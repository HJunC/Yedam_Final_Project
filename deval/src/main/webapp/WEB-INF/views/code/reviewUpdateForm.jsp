		...
		<div class="container relative text-center">
			<div class="row">
				<div class="col-lg-10 offset-lg-1">
					<h2 class="hs-line-7 mb-0 wow fadeInUpShort" data-wow-delay=".2s">리뷰 수정</h2>
				</div>
			</div>
		</div>
	</section>
	<section class="page-section bg-dark light-content pt-0">
		<form id="frm" action="reviewUpdate.do" method="post" onsubmit="inputCheck()">
		<input name="${_csrf.parameterName }" value="${_csrf.token}" type="hidden">
		<input type="hidden" id="subject" name="subject">
		<input type="hidden" name="cqReplyNo" value="${review.cqReplyNo}">
				...
				<div class="table-responsive">
					...
					<div align="right">
						...
						<input class="btn btn-mod btn-round btn-border-w btn-small"
							type="button" value="취소" onclick="location.href='reviewSelect.do?cqReplyNo=${review.cqReplyNo}'">
					</div>
				</div>
			</div>
		</form>
