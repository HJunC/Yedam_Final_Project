								...
								<c:if test="${code.cqType eq '공유' }">
									<table class="table shopping-cart-table">
										<tr>
											...
											<td><input type="hidden" id="cqNo" name="cqNo"
												value="${code.cqNo }"></td>
										</tr>
										<tr>
										...
										<tr>
											<th>GIT URI : <c:if test="${not empty code.gitUri }">
									...
									<div align="right">
										<input class="btn btn-mod btn-round btn-border-w btn-small"
											type="button" onclick="codeUpdate('U')" value="수정"> <input
											class="btn btn-mod btn-round btn-border-w btn-small"
											type="button" onclick="codeUpdate('D')" value="삭제"> <input
											class="btn btn-mod btn-round btn-border-w btn-small"
											type="button" value="목록"
											onclick="location.href='codeList.do'">
									</div>
								</c:if>
