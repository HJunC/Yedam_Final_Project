				...
				<div class="col-lg-5 d-flex align-items-center mb-md-60">
					<div>
						...
						<h2 class="hs-line-7 mb-60 mb-xs-40 wow fadeInUpShort"
							data-wow-delay=".2s">
							Developer Study<span class="sr-only">Challenge, Passion, cooperation</span> <span data-period="2800"
								data-type='[ "Challenge", "Passion", "cooperation"]' class="typewrite"
								aria-hidden="true"><span class="wrap"></span></span>
						</h2>
						<div class="local-scroll wow fadeInUpShort" data-wow-delay=".3s">
							<a href="#about"
								class="btn btn-mod btn-w btn-medium btn-round mx-md-1">See
								More</a> <a href="pages-services-1-dark.html"
								class="btn btn-mod btn-w btn-medium btn-round mx-md-1">Get
								Pricing</a>
						</div>
					</div>
				</div>
		...
		<div class="row">
			<div class="col-md-8">
				...
				<div class="wow fadeInUpShort" data-wow-delay=".2s">
					<p class="hs-line-6 opacity-075 mb-20 mb-xs-0">Developers's
						space, Learning together and growing up</p>
				</div>
			</div>
			<div class="col-md-4 mt-30 wow fadeInUpShort" data-wow-delay=".1s">
				<div class="mod-breadcrumbs text-end">
					<a href="addStudy.do">모임등록</a>&nbsp;<span
						class="mod-breadcrumbs-slash">•</span>&nbsp; <a href="#">모임검색</a>&nbsp;<span
						class="mod-breadcrumbs-slash">•</span>&nbsp; <a href="#">그룹원</a>&nbsp;<span
						class="mod-breadcrumbs-slash">•</span>&nbsp; <a href="#">신청자</a>&nbsp;<span
						class="mod-breadcrumbs-slash"></span>&nbsp;
		...
		<div class="mb-120 mb-sm-50">
			<div class="row section-text">
				...
				<div class="col-md-6 col-lg-4 mb-sm-50 mb-xs-30 wow linesAnimIn"
					data-wow-offset="0" data-splitting="lines">Lorem ipsum dolor
					sit amet conseur adipisci inerene maximus ligula sempe metuse
					pelente mattis. Maecenas volutpat, diam eni sagittis quam porta
					quam. Sed id dolor consectetur fermentum volutpat accumsan purus.</div>
				<div class="col-md-6 col-lg-4 mb-sm-50 mb-xs-30 wow linesAnimIn"
					data-wow-offset="0" data-splitting="lines">Etiam sit amet
					fringilla lacus susantebe sit ullamcorper pulvinar neque porttitor.
					Integere lectus. Praesent sede nisi eleifend fermum orci amet,
					iaculis libero. Donec vel ultricies purus. Name dictum sem ipsumebe
					euliquam.</div>
			</div>
		</div>
	</div>
...
<section class="page-section bg-dark light-content" id="services">
	<div class="container relative">
		...
		<div class="text-center mb-80 mb-sm-50">
			...
			<p class="section-title-descr">We provide the best digital
				solutions.</p>
		</div>
				...
				<div class="services-item text-center wow fadeIn"
					...
					<div class="services-icon">
						<svg width="24" height="24" viewBox="0 0 24 24"
							...
							clip-rule="evenodd">
                                            <path
								d="M15 7h4v5h5v6h-5v5h-19v-21h15v5zm-5 11h-9v4h9v-4zm8 0h-7v4h7v-4zm-11-5h-6v4h6v-4zm9 0h-8v4h8v-4zm7 0h-6v4h6v-4zm-12-5v4h7v-4h-7zm-1 0h-9v4h9v-4zm-3-5h-6v4h6v-4zm7 0h-6v4h6v-4z" />
                                        </svg>
					</div>
