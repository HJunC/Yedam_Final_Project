                  ...
                  <input type="hidden" name="boardTypeNo" value="${board.boardNo}">
							...
							<c:if test="${board.boardTypeNo != 1}">
								<c:if test="${user == board.writer}">
									<input class="btn btn-mod btn-round btn-border-w btn-small"
										type="button" onclick="boardUpdate('U')" value="수정">
									<input class="btn btn-mod btn-round btn-border-w btn-small"
										type="button" onclick="boardUpdate('D')" value="삭제">
								</c:if>
							</c:if>
						...
						<table>
							<tr>
								...
								<th>관리자 &nbsp;<input type="hidden" value="${board.writer}"
									name="writer" id="writer">${board.writer}</th>
                  ...
                  <div class="mb-80 mb-xs-40"> -->
					...
					<table id="tbl">
						<c:forEach items="${comments}" var="comment">
							...
							<tr>
								<th colspan="100">${comment.commentSubject}
									<h4 class="blog-page-title"></h4>
								</th>
							</tr>
						</c:forEach>
